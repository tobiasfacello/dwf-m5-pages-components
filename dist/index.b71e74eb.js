...
const routes = [
    ...
    {
        path: /^\/s./,
        component: _step1.initStepOnePage
    },
    {
        path: /^\/t./,
        component: _thankyou.initThankYouPage
    }, 
];
function initRouter(container) {
    ...
    if (location.pathname == "/") window.addEventListener("load", ()=>{
        goTo("/welcome");
    });
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initThankYouPage", ()=>initThankYouPage
);
function initThankYouPage(params) {
    const div = document.createElement("div");
    div.innerHTML = `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5bBp7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "init", ()=>init
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kPNzl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "init", ()=>init
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fIu2R":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "init", ()=>init
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hZCm9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "init", ()=>init
);
function init() {
    class TextfieldComponent extends HTMLElement {
        ...
        render() {
            ...
            if (textfield.getAttribute("placeholder") !== "") textfield.setAttribute("placeholder", `${originalPlaceholder}`);
            const fieldLabel = document.createElement("label");
            fieldLabel.classList.add("textfield-label");
            if (textfield.getAttribute("label") !== "") fieldLabel.textContent = `${originalLabel}`;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"rFYED":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "init", ()=>init
);
function init() {
    class SelectComponent extends HTMLElement {
        ...
        render() {
            ...
            if (select.getAttribute("label") !== "") fieldLabel.textContent = `${originalLabel}`;
            container.appendChild(fieldLabel);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gGTGU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "init", ()=>init
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8wcER","h7u1C"], "h7u1C", "parcelRequire6acf")
